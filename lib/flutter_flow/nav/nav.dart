        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'promptQuestions',
              builder: (context, params) => params.isEmpty
                  ? const NavBarPage(initialPage: 'PromptQuestions')
            ...
            FFRoute(
              name: 'RecipePageVisit',
              path: 'recipePageVisit',
              builder: (context, params) => RecipePageVisitWidget(
                firstResponse: params.getParam(
                  'firstResponse',
                  ParamType.DocumentReference,
                  isList: false,
                  collectionNamePath: ['saved_recipes'],
                ),
              ),
            )
