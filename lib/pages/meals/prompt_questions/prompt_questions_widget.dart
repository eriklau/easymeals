...
class PromptQuestionsWidget extends StatefulWidget {
  const PromptQuestionsWidget({super.key});
...
class _PromptQuestionsWidgetState extends State<PromptQuestionsWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'PromptQuestions'});
          ...
          child: Column(
            ...
            children: [
                                    ...
                                    children: [
                                      Align(
                                        alignment:
                                            const AlignmentDirectional(-1.0, 0.0),
                                        child: Text(
                                          'Additional Condiments, Seasonings,  Sauces, etc.',
                                          textAlign: TextAlign.start,
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                                    ...
                                    children: [
                                      ...
                                      FlutterFlowChoiceChips(
                                        options: const [
                                          ...
                                          ChipData('Dessert', Icons.cake),
                                          ChipData('Appetizer', Icons.egg),
                                          ChipData('Drink',
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('PROMPT_QUESTIONS_CreateRecipe_ON_TAP');
                    logFirebaseEvent('CreateRecipe_update_page_state');
                    _model.userInput = functions.convertToJSON(
                        'I need you to help me find recipes with a set of requirements.I have the following ingredients: ${_model.descriptionTextController1.text}. I also have the following condiments: ${_model.descriptionTextController2.text}. I am making a meal for ${_model.choiceChipsValue1}. I only have this much time to make it: ${_model.choiceChipsValue2}. My cooking skill level is ${_model.choiceChipsValue3}');
                    setState(() {});
                    logFirebaseEvent('CreateRecipe_backend_call');
                    _model.apiResultf00 = await OpenAIChatGPTCopyGroup
                          ...
                          "parameters": {
                            ...
                            "properties": {
                              ...
                              "ingredients": {
                                "type": "array",
                                "description":
                                    "Steps for each ingredient and their amount (no numbering)",
                                "items": {"type": "string"}
                              },
                              "instructions": {
                                "type": "array",
                                "description":
                                    "Steps to prepare the recipe (no numbering)",
                                "items": {"type": "string"}
                              },
                              "time_to_cook": {
                                "type": "number",
                                "description":
                                    "Total time to prepare the recipe in minutes"
                              },
                              "price_to_cook": {
                                "type": "number",
                                "description":
                      ...
                      functionCallJson: {"name": "set_recipe"},
                    );

                    if ((_model.apiResultf00?.succeeded ?? true)) {
                      ...
                      context.pushNamed(
                        ...
                        queryParameters: {
                          'firstResponse': serializeParam(
                            functions.convertAPIStringToJSON(getJsonField(
                              (_model.apiResultf00?.jsonBody ?? ''),
                      ...
                      logFirebaseEvent('CreateRecipe_show_snack_bar');
