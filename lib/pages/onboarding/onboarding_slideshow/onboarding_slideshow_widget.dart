                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: Image.network(
                                                'https://images.unsplash.com/photo-1464093515883-ec948246accb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxkaXNofGVufDB8fHx8MTcyMzgzNjgwNXww&ixlib=rb-4.0.3&q=80&w=400',
                                                height: 250.0,
                                                fit: BoxFit.fill,
                                              ),
                                            ).animateOnPageLoad(animationsMap[
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 48.0, 0.0, 0.0),
                                            child: Text(
                                              'Create your own customized meal recipes, at your own pace or place.',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 48.0, 0.0, 0.0),
                                            child: Text(
                                              'Enjoy healthy and delicious meals prepared with high-quality guidance.',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 48.0, 0.0, 0.0),
                                            child: Text(
                                              'Savor chef-inspired meals without the hassle of looking up convoluted recipes. ',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
